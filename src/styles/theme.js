...
export const color_lightBlueGrey = '#C6D0DD';
...
export const font_size_smaller = 12;
...
export const font_size_bigger = 22;
export const font_size_huge = 24;

// ICON FONT SIZES
export const icon_font_size_base = 15;
export const icon_font_size_medium = 20;
export const icon_font_size_big = 25;
export const icon_font_size_bigger = 30;
export const icon_font_size_huge = 35;

// BORDER RADIUS
export const border_radius_rounded_small = 4;
export const border_radius_rounded = 8;
export const border_radius_rounded_big = 15;
export const border_radius_rounded_huge = 24;
...
export const gutter_width_small = 10;
export const gutter_width_medium = 20;
export const gutter_width_big = 25;
export const gutter_width_huge = 30;
